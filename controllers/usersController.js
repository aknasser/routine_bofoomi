...
// AJOUT DE NOUVELLES ACTIVITES CORPS
    ...
    saveActivitiesCorps:(req, res, next) => {                                 // ACTION POUR SAUVEGARDER ACTIVITE DANS L'USER MODEL ET REDIRIGER VERS LE CHOXI DE NOUVELLE ACTIVITE
            ...
            .then(() => {
                return ActivitesPasseesCorps.create({                               // ON ajoute la nouvelle activitePassees dans la db
                    user: userActif._id,
            ...
            .then(activitePassee => {
                userActif.activitesPasseesCorps.push(activitePassee);               // On attribue cette activité passée à l'user actuel
...
// AJOUT DE NOUVELLES ACTIVITES Esprit
    ...
    User.findById(userId).populate("esprit activitesEsprit activitesPasseesEsprit")
        ...
        .then(()=> {
            return ActivitesPasseesEsprit.create({
                user: userActif._id,
        ...
        .then(activitePassee => {
            userActif.activitesPasseesEsprit.push(activitePassee);           // 3-  PUSHER l'activite terminée DANS L'ARRAY ActivitesPasseesCategorie de l'user
            console.log(`Activite incorporée dans ActivitesPassees: ${activitePassee}`);
    ...
    saveActivitiesSocial:(req, res, next) => {                                 // ACTION POUR SAUVEGARDER ACTIVITE DANS L'USER MODEL ET REDIRIGER VERS LE CHOXI DE NOUVELLE ACTIVITE
            ...
            .then(() =>{
                return ActivitesPasseesSocial.create({
                    user: userActif._id,
            ...
            .then(activitePassee => {
                ...
                userActif.activitesPasseesSocial.push(activitePassee);           // 3-  PUSHER l'activite terminée DANS L'ARRAY ActivitesPasseesCategorie de l'user
                console.log(`L'activite pushé dans l'User: ${activitePassee}`);
...
// AJOUT DE NOUVELLES ACTIVITES ARTS
    ...
    saveActivitiesArts:(req, res, next) => {                                 // ACTION POUR SAUVEGARDER ACTIVITE DANS L'USER MODEL ET REDIRIGER VERS LE CHOXI DE NOUVELLE ACTIVITE
            ...
            .then(() => {
                return ActivitesPasseesArts.create({
                    user: userActif._id,
            ...
            .then(activitePassee => {
                ...
                userActif.activitesPasseesArts.push(activitePassee);           // 3-  PUSHER l'activite terminée DANS L'ARRAY ActivitesPasseesCategorie de l'user
    ...
    saveActivitiesStyle:(req, res, next) => {                                 // ACTION POUR SAUVEGARDER ACTIVITE DANS L'USER MODEL ET REDIRIGER VERS LE CHOXI DE NOUVELLE ACTIVITE
            ...
            .then(() => {
                return ActivitesPasseesStyle.create({
                    user: userActif._id,
            ...
            .then(activitePassee => {
                ...
                userActif.activitesPasseesStyle.push(activitePassee);           // 3-  PUSHER l'activite terminée DANS L'ARRAY ActivitesPasseesCategorie de l'user
...
// AJOUT DE NOUVELLES ACTIVITES COOKING
    ...
    saveActivitiesCooking:(req, res, next) => {                                 // ACTION POUR SAUVEGARDER ACTIVITE DANS L'USER MODEL ET REDIRIGER VERS LE CHOXI DE NOUVELLE ACTIVITE
            ...
            .then(() => {
                return ActivitesPasseesCooking.create({
                    user: userActif._id,
            ...
            .then(activitePassee => {
                ...
                userActif.activitesPasseesCooking.push(activitePassee);           // 3-  PUSHER l'activite terminée DANS L'ARRAY ActivitesPasseesCategorie de l'user
...
// LES ACTIVITES REALISEES PAR L'USER
    ...
    OldActivities: (req, res) => {          
        ...
        let activite = req.params.categorie;                    // 3 - On récupère la catégorie choisie par l'user. Cela nous permet de savoir dans quelle categorie chercher
        let activitePasseeModel = mongoose.model(activite)  // 4 - Avec mongoose.model on "transforme" on cale le model ayant pour nom la valeur d'activite dans la variable "activitePasseeModel"(you feel me ?)
        activitePasseeModel.find({user: userId})         // 5 - On utilise activitePasseeModel pour trouver toutes les activites ayant pour userId dans son Array d'user
        .then(activitiesDone => {
            oldActivities = activitiesDone;    // 6 - ON cale le résultat dans la variable oldActivities
...
// LOGIN - LOGOUT
    ...
    passport.authenticate("local", {
        ...
        successRedirect:`/users/hero/5fd62fce1def4444e060983f`,      // PAGE DE DESTINATION EN CAS DE SUCCES
    }),
